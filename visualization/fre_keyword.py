...
# ----------------------
plot_korean_keywords('database/preprocessed_reviews_aladin.csv')
# plot_korean_keywords('database/preprocessed_reviews_reviews_kyobo.csv')
# plot_korean_keywords('database/preprocessed_reviews_reviews_yes24.csv')
